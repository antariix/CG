...
void drawClippingWindow() {
    ...
    glVertex2f(x_min, y_min); glVertex2f(x_min, y_max);
    glVertex2f(x_max, y_max); glVertex2f(x_max, y_min);
    glEnd();
}

void displayOriginalLine() {
    glClear(GL_COLOR_BUFFER_BIT);
    glColor3f(1.0f, 0.0f, 0.0f); drawClippingWindow();
    glColor3f(0.0f, 1.0f, 0.0f);
    drawLine(-0.8f, -0.7f, 0.9f, 0.8f);
    glFlush();
}
